...
export async function GET(req: NextRequest, { params }: RouteParams) {
  ...
  if (athleteIds.length > 0) {
    ...
    const TEST_IDS: Record<string, string> = {
      "td000001-0000-0000-0000-000000000000": "sprint",
      "td000002-0000-0000-0000-000000000000": "agility",
      "td000003-0000-0000-0000-000000000000": "yoyo",
      "td000004-0000-0000-0000-000000000000": "dribble",
      "td000005-0000-0000-0000-000000000000": "passing",
      "td000006-0000-0000-0000-000000000000": "shooting",
    };
